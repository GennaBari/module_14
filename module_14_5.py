...
bottom4 = KeyboardButton(text='Регистрация')

kb.row(bottom, bottom2, bottom3, bottom4)
...
inline_bottom5 = InlineKeyboardButton('Product1', callback_data='product_buying')
inline_bottom6 = InlineKeyboardButton('Product2', callback_data='product_buying')
...
async def get_buying_list(message):
   ...
   for i in range(1, 5):
        await message.answer(f'Product{i} | description {i} | price {i * 100}')
